const CACHE='genevieve-dogpark-ga-emergency-2026-07-14-v8';
const VERSION='2026.07.14.8';
const ASSETS=[
  './','./index.html','./styles.css?v=20260714.8','./config.js?v=20260714.8','./logic.js?v=20260714.8',
  './app.js?v=20260714.8','./backend.js?v=20260714.8','./native-billing-bridge.js?v=20260714.8',
  './manifest.webmanifest?v=20260714.8','./assets/ga-favicon-64-v8.png','./assets/ga-apple-touch-icon-180-v8.png',
  './assets/ga-app-icon-192-v8.png','./assets/ga-app-icon-512-v8.png',
  './assets/genevieve-ga-logo-approved-original.png','./assets/ga-logo-full-square-v8.png',
